...
function Home() {
  let data = [
      ...
      let filterdata = data.filter((singlematch) => singlematch["matchDetailsMap"])
    ...
    //   console.log(matchesdata);
      ...
      return (
        <div className=" bg-[#22242A] text-white w-[50%] min-h-screen grid grid-cols-2 ">
         
              {
                  matchesdata.map((data, i) => (
                      data.matchDetailsMap.match.map((singlematch,i) => (
                          <Link to={`/matchdetails/${singlematch.matchInfo.matchId}`}>
                            <div className="border-[1px] border-[#9E9E99] w-[100%] p-3 gap-[20px] ">
                                <div className="flex justify-between">
                                    <p>{singlematch.matchInfo.matchDesc} {singlematch.matchInfo.matchFormat}</p>
                                    <p>{data.matchDetailsMap.key}</p>
                                    
                                </div>
                                <div className="flex justify-between items-center">
                                    <div className="flex gap-3 items-center">
                                    <img className="w-[50px] rounded-[100%]" src={`https://documents.iplt20.com/ipl/${singlematch.matchInfo.team1.teamSName}/Logos/Roundbig/${singlematch.matchInfo.team1.teamSName}roundbig.png`} alt=""  onError={(e) => {
    e.currentTarget.onerror = null;
    e.currentTarget.src = "https://cdorg.b-cdn.net/wp-content/uploads/2022/03/Cricketdata-IPL-Flag-Chennai-Super-Kings-1.jpg";
  }} />
                                    <p className="text-[17px]">{singlematch.matchInfo.team1.teamSName}</p>
                                    </div>
                                    <p>{singlematch.matchScore.team1Score.inngs1.runs}/{singlematch.matchScore.team1Score.inngs1.wickets}({singlematch.matchScore.team1Score.inngs1.overs})</p>
                                </div>
                                <div className="flex justify-between items-center">
                                    <div className="flex gap-3 items-center">
                                    <img className="w-[50px] rounded-[100%] " src={`https://documents.iplt20.com/ipl/${singlematch.matchInfo.team2.teamSName}/Logos/Roundbig/${singlematch.matchInfo.team2.teamSName}roundbig.png`} alt="" onError={(e) => {
    e.currentTarget.onerror = null;
    e.currentTarget.src = "https://cdorg.b-cdn.net/wp-content/uploads/2022/03/Cricketdata-IPL-Flag-Chennai-Super-Kings-1.jpg";
  }}  />
                                    <p>{singlematch.matchInfo.team2.teamSName}</p>
                                    </div>
                                    <p>{singlematch.matchScore.team2Score?.inngs1.runs}/{singlematch.matchScore.team2Score?.inngs1.wickets}({singlematch.matchScore.team2Score?.inngs1.overs})</p>
                                </div>
                                <div>
